...
Toast 앱은 OAuth 2.0 프로토콜을 사용하여 안전한 사용자 인증을 제공합니다.
...
3. **토큰 새로고침**:
   - 액세스 토큰은 수명이 짧고(일반적으로 1시간) 자동으로 새로고침됩니다.
   - 새로고침 토큰은 더 오래 지속되지만 필요에 따라 교체됩니다.
   - 토큰 새로고침은 사용자가 여러 기기에서 동시에 로그인한 상태를 유지할 수 있도록 조정됩니다.
