...
### 설명
시스템에 키보드 단축키를 전송하는 액션입니다.

### 속성
| 속성 | 타입 | 필수 | 설명 |
|------|------|------|------|
| `keys` | string | 예 | 실행할 키보드 단축키 (예: "Ctrl+C") |
...
### 지원되는 키
- 수정자 키: Ctrl, Alt, Shift, Command/Super
- 기능 키: F1-F12
- 특수 키: Enter, Escape, Tab, Space, Backspace, Delete, Home, End, PageUp, PageDown
- 방향 키: Up, Down, Left, Right
- 일반 문자 키: A-Z, 0-9, 기타 문자

### 구현 세부사항
- @nut-tree-fork/nut-js 라이브러리를 사용하여 키보드 이벤트 생성
- 여러 키 조합 지원 (`Ctrl+Shift+T` 등)
