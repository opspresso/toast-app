...
### Testing & Quality
- **Run Tests**: `npm run test` (Jest - 34 test suites, 966 unit tests)
...
- **Unit Tests**: 34 test suites, 966 unit tests
...
- **Current Tests**: 34 test suites, 966 unit tests
...
├── unit/                  # Unit tests (966 tests in 34 suites)
