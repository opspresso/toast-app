...
### Testing & Quality
- **Run Tests**: `npm run test` (Jest - 27 test suites, 630+ unit tests)
...
- **Unit Tests**: 27 test suites, 630+ unit tests
...
- **Current Tests**: 27 test suites, 630+ unit tests
...
├── unit/                  # Unit tests (630+ tests in 27 suites)
